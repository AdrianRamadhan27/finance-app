...
export default function EditWallet({id, afterSubmit}) {
  ...
  const handleSubmit = (e) => {
    ...
    axios.put(`${baseURL}/wallets/${id}`, expenseData)
      .then(response => {
  ...
  return (
    <div className="flex flex-col gap-2 text-center p-3 max-w-6xl">
      <h1 className="font-bold">Edit Wallet</h1>
